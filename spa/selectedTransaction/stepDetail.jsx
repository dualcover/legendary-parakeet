            ...
            <div className={"w3-panel" + (step.parent ? " w3-margin-left" : "")} style={{ "border-color": color }}>
                ...
                {step.logs && step.logs.length > 0 && <p>
                    ...
                    {step.logs.map(log => <div key={log.key} className="w3-container">
                        ...
                        <p>Launcher: <Address value={log.address} address={CodeDecoder.decodeAddress(log.address, log.addressCodeHash, additionalData)} isContract={log.addressCodeHash} /></p>
                        <h6>Parameters</h6>
