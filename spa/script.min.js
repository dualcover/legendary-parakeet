"use strict";function _typeof(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?_typeof=function(t){return typeof t}:_typeof=function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(e)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){function o(e,t){try{var n=s[e](t),o=n.value}catch(f){i(f);return}n.done?r(o):Promise.resolve(o).then(u,a)}function u(e){o("next",e)}function a(e){o("throw",e)}var s=e.apply(t,n);u()})}}(window.preloadedScripts=window.preloadedScripts||[]).push(...['spa/components/address.jsx','spa/components/tag.jsx','spa/config/controller.js','spa/config/style.min.css','spa/config/view.jsx','spa/index/controller.js','spa/index/style.min.css','spa/index/view.jsx','spa/selectedTransaction/controller.js','spa/selectedTransaction/logLabel.jsx','spa/selectedTransaction/stepDetail.jsx','spa/selectedTransaction/style.min.css','spa/selectedTransaction/view.jsx','spa/transactions/controller.js','spa/transactions/style.min.css','spa/transactions/view.jsx']);var Address=function(t){var n=t.isContract,r=t.shorten,i=t.address,s=t.value;return React.createElement(React.Fragment,null,(n===!0||n!=="0x")&&React.createElement(React.Fragment,null,React.createElement("i",{className:"fa fa-file"})," "),React.createElement("a",{target:"_blank",href:window.getEtherscanAddress("address/"+s),onClick:function(t){return t.stopPropagation()}},r&&window.shortenWord(i,20),!r&&i))};var Tag=function(t){var n=t.color,r=t.icon,i=t.children,s=t.bold;return React.createElement("span",{className:"w3-tag w3-padding w3-round "+(n?n.indexOf("w3")===0?n:"w3-"+n:"w3-theme-l2")},r&&React.createElement(React.Fragment,null,React.createElement("i",{className:"fa fa-"+r})," "),s&&React.createElement("b",null,i),!s&&i)};var ConfigController = function(view) {
    ...
    var context = this;
    context.view = view;
};;var LogLabel=React.createClass({displayName:"LogLabel",decode:{"0xe1fffcc4923d04b559f4d29a8bfc6cda04eb5b0d3c460751c2402c5c5cc9109c":function(t,n){var r=CodeDecoder.decodeAddress(abi.decode(["address"],t.topics[1])[0],undefined,n,!0);return React.createElement(React.Fragment,null,"Wrap of ~ ",window.fromDecimals(abi.decode(["uint256"],t.data)[0].toString(),18)," $ETH by ",r)},"0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef":function(t,n){var r=window.fromDecimals(abi.decode(["uint256"],t.data)[0].toString(),18);r==="0"?r=window.fromDecimals(abi.decode(["uint256"],t.data)[0].toString(),18,!0):r="~ "+r;var i=CodeDecoder.decodeAddress(t.address,t.addressCodeHash,n);i=i.split(" ")[0],i=i.indexOf("0x")===0?"tokens":"$"+i;var s=t.topics[1]===window.voidBytes32?"minted":t.topics[2]===window.voidBytes32?"burned":"transferred",o=r+" "+i+" "+s;if(s==="transferred"||s===" burned")o+=" "+(s==="transferred"?"from":"by")+" "+CodeDecoder.decodeAddress(abi.decode(["address"],t.topics[1])[0],undefined,n,!0);if(s==="transferred"||s==="minted"&&t.topics[2]!==window.voidBytes32)o+=" to "+CodeDecoder.decodeAddress(abi.decode(["address"],t.topics[2])[0],undefined,n,!0);return s==="minted"&&t.topics[2]===window.voidBytes32&&(o+=" and then burned"),React.createElement("span",{ref:function(t){return t&&(t.innerHTML=o)}})}},render:function(){var t=this.props,n=t.step,r=t.additionalData;return React.createElement(React.Fragment,null,this.decode[n.topics[0]]&&this.decode[n.topics[0]](n,r)||CodeDecoder.decodeLog(n,r,!0))}});function _extends(){return _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},_extends.apply(this,arguments)}var StepDetail=React.createClass({displayName:"StepDetail",requiredScripts:["assets/scripts/codeDecoder.js","spa/components/address.jsx","spa/components/tag.jsx"],renderColor:function(){var t=this.props.step,n=t.parent?t.parent.from+t.parent.to+t.parent.type+t.parent.data+t.parent.result:"";return web3.utils.sha3(n+t.from+t.to+t.type+t.data+t.result).substring(2,5)},renderSubSteps:function(t,n,r,i){var s=[];return s=[].concat(t.steps||[],t.logs||[]).reduce(function(e,t){var n;return _extends({},e,(n={},n[t.index]=t,n))},{}),s=Object.keys(s).sort(function(e,t){return parseInt(e)-parseInt(t)}).map(function(e){return s[e]}),s.map(function(e,t){return React.createElement(StepDetail,{key:t,step:e,additionalData:n,showDetails:r,highlights:i})})},render:function(){var t=this.props,n=t.step,r=t.additionalData,i=t.showDetails,s=t.highlights,o=useState(this,i),u=o[0],a=o[1];useEffect(this,function(){return a(i)},[i]);var f="#"+this.renderColor(),l=this.renderSubSteps(n,r,i,s);if(!s.VALUE||!n.value||n.value==="0")if(n.parent&&!s[n.type])return l;return React.createElement("div",{className:"w3-panel"+(n.parent?" w3-margin-left":""),style:{"border-color":f}},n.type!=="LOG"&&React.createElement("p",null,"From ",React.createElement(Address,{value:n.from,address:CodeDecoder.decodeAddress(n.from,n.fromCodeHash,r),isContract:n.fromCodeHash})," to ",React.createElement(Address,{value:n.to,address:CodeDecoder.decodeAddress(n.to,n.toCodeHash,r),isContract:n.toCodeHash})),React.createElement("a",{onClick:function(){return a(!u)},style:{cursor:"pointer"}},React.createElement("p",null,React.createElement("span",{style:{"font-weight":!u||(n.type==="CREATE"||n.type==="CREATE2"||n.type==="TRANSFER")&&!i?"bolder":"normal"}},React.createElement("i",{className:"fa fa-"+(n.type==="LOG"?"bullhorn":"arrow-right-arrow-left")})," ",n.type==="LOG"?React.createElement(LogLabel,{step:n,additionalData:r}):CodeDecoder.decodeMethodLabel(n,r,!0))," ","|"," ",React.createElement(Tag,null,n.type),n.type!=="LOG"&&React.createElement(React.Fragment,null," ","|"," ",React.createElement(Tag,{color:n.success?"green":"red",icon:n.success?"check":"times"},n.finishedReason||(n.success?"SUCCESS":"FAILED")),n.incomplete&&React.createElement(React.Fragment,null,React.createElement("span",null," "),React.createElement(Tag,{color:"khaki",icon:"warning"},"NOT RELIABLE STACK"))))),React.createElement("p",null,(n.type==="CALL"||n.type==="CREATE"||n.type==="CREATE2"||n.type==="TRANSFER")&&React.createElement("span",null,"Value: ",window.fromDecimals(n.value,18,!0)," ETH"),n.gasUsed&&React.createElement("span",null," Gas: ",window.formatMoney(n.gas)),n.gasUsed&&React.createElement("span",null," Gas Used: ",window.formatMoney(n.gasUsed)),n.gasPrice&&React.createElement("span",null," Gas Price: ",window.fromDecimals(n.gasPrice,9,!0)," GWEI")),n.type!=="LOG"&&u&&React.createElement("p",null,n.type!=="CREATE"&&n.type!=="CREATE2"&&n.type!=="TRANSFER"&&React.createElement(React.Fragment,null,React.createElement("h5",null,React.createElement("b",null,"Method")),React.createElement("h6",null,React.createElement("span",{className:"w3-code"},CodeDecoder.decodeMethodLabel(n,r))),n.params&&n.params!=="0x"&&React.createElement(React.Fragment,null,React.createElement("h6",null,"Input"),React.createElement("div",{className:"w3-code w3-border-gray w3-light-gray",ref:function(t){return t&&(t.innerHTML=CodeDecoder.decodeMethodInput(n,r))}}))),(n.result&&n.result!=="0x"||!n.success)&&u&&React.createElement(React.Fragment,null,React.createElement("h6",null,"Output"),React.createElement("div",{className:"w3-code w3-border-gray w3-light-gray",ref:function(t){return t&&(t.innerHTML=CodeDecoder.decodeMethodOutput(n,r))}}))),n.type==="LOG"&&u&&React.createElement("p",null,React.createElement("h5",null,React.createElement("b",null,"Event")),React.createElement("div",{className:"w3-container"},React.createElement("h6",null,React.createElement("span",{className:"w3-code"},CodeDecoder.decodeLog(n,r))),React.createElement("p",null,"Launcher: ",React.createElement(Address,{value:n.address,address:CodeDecoder.decodeAddress(n.address,n.addressCodeHash,r),isContract:n.addressCodeHash})),React.createElement("h6",null,"Parameters"),React.createElement("div",{className:"w3-code w3-border-gray w3-light-gray",ref:function(t){return t&&(t.innerHTML=CodeDecoder.decodeLogInput(n,r,!0))}}))),l)}});function _extends(){return _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},_extends.apply(this,arguments)}var SelectedTransaction=React.createClass({displayName:"SelectedTransaction",requiredScripts:["spa/components/address.jsx","spa/components/tag.jsx","spa/selectedTransaction/stepDetail.jsx","spa/selectedTransaction/logLabel.jsx"],extractHighlights:function(t){var n,r=t.logs&&t.logs.length>0,i=!isNaN(parseInt(t.value))&&parseInt(t.value)!==0,s=(n={},n[t.type]=t.type==="TRANSFER",n),o=this;return(t.steps||[]).forEach(function(e){return s=_extends({},s,o.extractHighlights(e))}),s=Object.keys(s).sort().reduce(function(e,t){var n;return _extends({},e,(n={},n[t]=s[t],n))},{}),s=r?_extends({},s,{LOG:r}):s,s=i&&Object.values(s).length>1?_extends({},s,{VALUE:i}):s,s},render:function(){var t=this,n=this.props.transaction,r=this.props.transactionsList,i=this.props.additionalData,s=r.indexOf(n),o=s>0&&function(){return t.props.onTransaction(r[s-1],r)},u=s<r.length-1&&function(){return t.props.onTransaction(r[s+1],r)},a=useState(this,!1),f=a[0],l=a[1],c=useState(this,{}),h=c[0],p=c[1];return useEffect(this,function(){return p(t.extractHighlights(n))},[n]),React.createElement("div",{className:"w3-container"},React.createElement("div",{className:"w3-container"},React.createElement("div",{className:"w3-container w3-left"},React.createElement("a",{className:"w3-button",href:"javascript:;",onClick:function(){return t.props.onTransaction()}},React.createElement("i",{className:"fa fa-arrow-left"})," ","Back")),React.createElement("div",{className:"w3-container w3-right"},React.createElement("a",{className:"w3-button"+(o?"":" w3-disabled"),href:"javascript:;",onClick:o},React.createElement("i",{className:"fa fa-arrow-left"})," ","Prev")," ",React.createElement("span",null,s+1," of ",r.length)," ",React.createElement("a",{className:"w3-button"+(u?"":" w3-disabled"),href:"javascript:;",onClick:u},"Next"," ",React.createElement("i",{className:"fa fa-arrow-right"})))),React.createElement("h3",null,"Transaction ",React.createElement("a",{target:"_blank",href:window.getEtherscanAddress("tx/"+n.transactionHash)},n.transactionHash)," | Block: #",n.blockNumber,n.blockTimestamp&&React.createElement(React.Fragment,null," | Mined at: ",(new Date(n.blockTimestamp*1e3)).toLocaleString())),React.createElement("p",null,React.createElement("label",null,"Show details"," ",React.createElement("input",{type:"radio",onChange:function(){return l(!0)},checked:f}))," ",React.createElement("label",null,"Collapse details"," ",React.createElement("input",{type:"radio",onChange:function(){return l(!1)},checked:!f})),Object.entries(h).length>1&&Object.entries(h).map(function(e){return React.createElement(React.Fragment,null," ","|"," ",React.createElement("label",null,"Show ",e[0]," ",React.createElement("input",{type:"checkbox",onChange:function(n){var r;return p(_extends({},h,(r={},r[e[0]]=n.currentTarget.checked,r)))},checked:e[1]})))})),React.createElement(StepDetail,{step:n,additionalData:i,showDetails:f,highlights:h}))}});var TransactionsController = function(view) {
    var context = this;
    context.view = view;
