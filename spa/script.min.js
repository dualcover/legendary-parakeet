"use strict";function _typeof(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?_typeof=function(t){return typeof t}:_typeof=function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(e)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){function o(e,t){try{var n=s[e](t),o=n.value}catch(f){i(f);return}n.done?r(o):Promise.resolve(o).then(u,a)}function u(e){o("next",e)}function a(e){o("throw",e)}var s=e.apply(t,n);u()})}}(window.preloadedScripts=window.preloadedScripts||[]).push(...['spa/components/address.jsx','spa/components/tag.jsx','spa/config/controller.js','spa/config/style.min.css','spa/config/view.jsx','spa/index/controller.js','spa/index/style.min.css','spa/index/view.jsx','spa/selectedTransaction/controller.js','spa/selectedTransaction/stepDetail.jsx','spa/selectedTransaction/style.min.css','spa/selectedTransaction/view.jsx','spa/transactions/controller.js','spa/transactions/style.min.css','spa/transactions/view.jsx']);var Address=function(t){var n=t.isContract,r=t.shorten,i=t.address,s=t.value;return React.createElement(React.Fragment,null,(n===!0||n!=="0x")&&React.createElement(React.Fragment,null,React.createElement("i",{className:"fa fa-file"})," "),React.createElement("a",{target:"_blank",href:"https://etherscan.io/address/"+s,onClick:function(t){return t.stopPropagation()}},r&&window.shortenWord(i,20),!r&&i))};var Tag=function(t){var n=t.color,r=t.icon,i=t.children,s=t.bold;return React.createElement("span",{className:"w3-tag w3-padding w3-round "+(n?n.indexOf("w3")===0?n:"w3-"+n:"w3-theme-l2")},r&&React.createElement(React.Fragment,null,React.createElement("i",{className:"fa fa-"+r})," "),s&&React.createElement("b",null,i),!s&&i)};var ConfigController = function(view) {
    ...
    var context = this;
    context.view = view;
};;var StepDetail=React.createClass({displayName:"StepDetail",requiredScripts:["assets/scripts/codeDecoder.js","spa/components/address.jsx","spa/components/tag.jsx"],renderColor:function(){var t=this.props.step,n=t.parent?t.parent.from+t.parent.to+t.parent.type+t.parent.data+t.parent.result:"";return web3.utils.sha3(n+t.from+t.to+t.type+t.data+t.result).substring(2,6)},render:function(){var t=this.props,n=t.step,r=t.additionalData,i="#"+this.renderColor();return React.createElement("div",{className:"w3-panel"+(n.parent?" w3-margin-left":""),style:{"border-color":i}},React.createElement("p",null,"From ",React.createElement(Address,{value:n.from,address:CodeDecoder.decodeAddress(n.from,n.fromCodeHash,r),isContract:n.fromCodeHash})," to ",React.createElement(Address,{value:n.to,address:CodeDecoder.decodeAddress(n.to,n.toCodeHash,r),isContract:n.toCodeHash})),React.createElement("p",null,React.createElement("span",null,"Type: "),React.createElement(Tag,null,n.type),React.createElement("span",null," Verdict: "),React.createElement(Tag,{color:n.success?"green":"red",icon:n.success?"check":"times"},n.success?"SUCCESS":"FAILED"),n.incomplete&&React.createElement(React.Fragment,null,React.createElement("span",null," "),React.createElement(Tag,{color:"khaki",icon:"warning"},"NOT RELIABLE STACK"))),React.createElement("p",null,React.createElement("span",null,"Value: ",window.fromDecimals(n.value,18,!0)," ETH"),React.createElement("span",null," Gas: ",window.formatMoney(n.gasUsed)),n.gasPrice&&React.createElement("span",null," Gas Price: ",window.fromDecimals(n.gasPrice,9)," GWEI")),React.createElement("p",null,n.type!=="CREATE"&&n.type!=="CREATE2"&&n.type!=="TRANSFER"&&React.createElement(React.Fragment,null,React.createElement("h5",null,React.createElement("b",null,"Method")),React.createElement("h6",null,React.createElement("span",{className:"w3-code"},CodeDecoder.decodeMethodLabel(n,r))),n.params&&n.params!=="0x"&&React.createElement(React.Fragment,null,React.createElement("h6",null,"Input"),React.createElement("div",{className:"w3-code w3-border-gray w3-light-gray",ref:function(t){return t&&(t.innerHTML=CodeDecoder.decodeMethodInput(n,r))}}))),(n.result&&n.result!=="0x"||!n.success)&&React.createElement(React.Fragment,null,React.createElement("h6",null,"Output"),React.createElement("div",{className:"w3-code w3-border-gray w3-light-gray",ref:function(t){return t&&(t.innerHTML=CodeDecoder.decodeMethodOutput(n,r))}}))),n.logs&&n.logs.length>0&&React.createElement("p",null,React.createElement("h5",null,React.createElement("b",null,"Events")),n.logs.map(function(e){return React.createElement("div",{key:e.key,className:"w3-container"},React.createElement("h6",null,React.createElement("span",{className:"w3-code"},CodeDecoder.decodeLog(e,r))),React.createElement("p",null,"Launcher: ",React.createElement(Address,{value:e.address,address:CodeDecoder.decodeAddress(e.address,e.addressCodeHash,r),isContract:e.addressCodeHash})),React.createElement("h6",null,"Parameters"),React.createElement("div",{className:"w3-code w3-border-gray w3-light-gray",ref:function(n){return n&&(n.innerHTML=CodeDecoder.decodeLogInput(e,r))}}))})),n.steps&&n.steps.map(function(e,t){return React.createElement(StepDetail,{key:t,step:e,additionalData:r})}))}});var SelectedTransaction=React.createClass({displayName:"SelectedTransaction",requiredScripts:["spa/components/address.jsx","spa/components/tag.jsx","spa/selectedTransaction/stepDetail.jsx"],render:function(){var t=this,n=this.props.transaction,r=this.props.transactionsList,i=this.props.additionalData,s=r.indexOf(n),o=s>0&&function(){return t.props.onTransaction(r[s-1],r)},u=s<r.length-1&&function(){return t.props.onTransaction(r[s+1],r)},a=s+1,f=r.length;return React.createElement("div",{className:"w3-container"},React.createElement("div",{className:"w3-container"},React.createElement("div",{className:"w3-container w3-left"},React.createElement("a",{className:"w3-button",href:"javascript:;",onClick:function(){return t.props.onTransaction()}},React.createElement("i",{className:"fa fa-arrow-left"})," ","Back")),React.createElement("div",{className:"w3-container w3-right"},React.createElement("a",{className:"w3-button"+(o?"":" w3-disabled"),href:"javascript:;",onClick:o},React.createElement("i",{className:"fa fa-arrow-left"})," ","Prev")," ",React.createElement("span",null,s+1," of ",r.length)," ",React.createElement("a",{className:"w3-button"+(u?"":" w3-disabled"),href:"javascript:;",onClick:u},"Next"," ",React.createElement("i",{className:"fa fa-arrow-right"})))),React.createElement("h3",null,"Transaction ",React.createElement("a",{target:"_blank",href:"https://etherscan.io/tx/"+n.transactionHash},n.transactionHash)," | Block: #",n.blockNumber,n.blockTimestamp&&React.createElement(React.Fragment,null," | Mined at: ",(new Date(n.blockTimestamp*1e3)).toLocaleString())),React.createElement(StepDetail,{step:n,additionalData:i}))}});var TransactionsController = function(view) {
    var context = this;
    context.view = view;
};;var Transactions=React.createClass({displayName:"Transactions",requiredScripts:["assets/scripts/codeDecoder.js","spa/components/address.jsx","spa/components/tag.jsx"],render:function(){var t=this,n=this;return React.createElement("div",{className:"w3-container"},React.createElement("h2",null,this.props.title||"Transactions"),React.createElement("table",{className:"w3-table-all w3-hoverable"},React.createElement("thead",null,React.createElement("tr",{className:"w3-theme"},React.createElement("th",null,"Txn Hash"),React.createElement("th",null,"Method"),React.createElement("th",null,"Block"),this.props.transactions[0].blockTimestamp&&React.createElement("th",null,"Date"),React.createElement("th",null,"From"),React.createElement("th",null,"To"),React.createElement("th",null," "))),React.createElement("tbody",null,this.props.transactions.map(function(e){return React.createElement("tr",{style:{cursor:"pointer"},onClick:function(){return t.props.onTransaction(e)},key:e.transactionHash,id:"txn_"+e.transactionHash},React.createElement("td",null,React.createElement("a",{href:"#txn_"+e.transactionHash,onClick:function(){return t.props.onTransaction(e)}},window.shortenWord(e.transactionHash,15))),React.createElement("td",null,React.createElement(Tag,{bold:!e.method||e.method==="0x"||!e.parent&&e.type!=="CALL"},CodeDecoder.decodeMethodLabel(e,n.props.additionalData,!0))),React.createElement("td",null,"# ",React.createElement("a",{target:"_blank",href:"https://etherscan.io/block/"+e.blockNumber},e.blockNumber)),e.blockTimestamp&&React.createElement("td",null,(new Date(e.blockTimestamp*1e3)).toLocaleString()),React.createElement("td",null,React.createElement(Address,{value:e.from,address:CodeDecoder.decodeAddress(e.from,e.fromCodeHash,n.props.additionalData,!0),isContract:e.fromCodeHash,shorten:!0})),React.createElement("td",null,React.createElement(Address,{value:e.to,address:CodeDecoder.decodeAddress(e.to,e.toCodeHash,n.props.additionalData,!0),isContract:e.toCodeHash,shorten:!0})),React.createElement("td",null,React.createElement(Tag,{color:e.success?"green":"red",icon:e.success?"check":"times"},e.success?"SUCCESS":"FAILED",e.incomplete&&React.createElement(React.Fragment,null," ",React.createElement("i",{className:"fa fa-warning w3-right",style:{color:"khaki"}})))))}))))}});